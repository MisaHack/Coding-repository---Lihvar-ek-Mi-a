...
function startDrawing(e){
   ...
   // Create a new path (with the curretn stroke color and stroke thickness)
   context.beginPath();
...
function changeColor(color, imgElement){
   ...
   // Return the previously clicked <img> element to its normal
...
// Keep thack of the clicked <img> element for thickness.
