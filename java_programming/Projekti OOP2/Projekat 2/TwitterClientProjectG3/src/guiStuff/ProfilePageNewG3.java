...
/**
 * Izgled "Profile" stranice Twitter-a.
 * 
 * @author <a href="mailto:lihvarcekmisa@yahoo.com"> Lihvarcek Misa </a>
 *
 */

public class ProfilePageNewG3 extends JFrame {
	...
	private ArrayList<TweetG3> tweetsList;
    ...
    */
	 ...
	 * Kreiranje okvira.
	 */
	public ProfilePageNewG3(UserG3 user) {
		 ...
		 */
		setLoggedUser(user);
		String statefulUserName = "ejb:/" + SERVER_PROJECT + "//" + UserG3Bean.class.getSimpleName()
				+ "!" + UserG3BeanRemote.class.getName() + "?stateful";
		String statefulTweetName = "ejb:/" + SERVER_PROJECT + "//" + TweetG3Bean.class.getSimpleName()
				+ "!" + TweetG3BeanRemote.class.getName() + "?stateful";
		String statefulUserTweetName = "ejb:/" + SERVER_PROJECT + "//" + UserTweetsG3Bean.class.getSimpleName()
		...
		btnProfile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					frame.setLoggedUser(loggedUser);
		...
		btnFollow.setToolTipText("Follow selected user");
		...
		final JLabel lblTweetsNumber = new JLabel(String.valueOf(userTweets.size()));
		...
		panel.setMaximumSize(new Dimension(350, 32767));
		panel.setMinimumSize(new Dimension(350, 10));
		panel.setPreferredSize(new Dimension(350, 10));
		userStatsPanel.add(panel);
		
		JButton btnFavourites = new JButton("FAVORITES");
		btnFavourites.setToolTipText("Your favorite Tweets");
		btnFavourites.setPreferredSize(new Dimension(100, 25));
		btnFavourites.setMinimumSize(new Dimension(100, 25));
		btnFavourites.setMaximumSize(new Dimension(100, 25));
		panel.add(btnFavourites);
		...
		userStatsPanel.add(panel_3);
		
		JButton btnE = new JButton("Edit profile");
		btnE.setPreferredSize(new Dimension(100, 25));
		btnE.setMaximumSize(new Dimension(100, 25));
		btnE.setMinimumSize(new Dimension(100, 25));
		panel_3.add(btnE);
...
//		scrollPane.setPreferredSize(new Dimension(438, 800));
//		scrollPane.setMinimumSize(new Dimension(400, 800));
//		scrollPane.setMaximumSize(new Dimension(400, 800));
//		tweetsPanel.add(scrollPane);
		if (getTweetsList()== null){
			setTweetsList(userTweets);
		}
		refreshTweetsInScrollPanel(getTweetsList());
...
//		tweetsInScrollPanel.add(tweetFramePanel5);
	 ...
	 * @author Nenad Barugdzic
	 */
	public void refreshTweetsInScrollPanel(ArrayList<TweetG3> tweetsList){
		tweetsInScrollPanel.removeAll();
		tweetsInScrollPanel.updateUI();
		tweetsInScrollPanel.validate();
		for (TweetG3 tweet : tweetsList){
	...
	public void setTweetsList(ArrayList<TweetG3> tweetsList){
		this.tweetsList = tweetsList;
	}
	
	public ArrayList<TweetG3> getTweetsList(){
		return tweetsList;
	}
}
